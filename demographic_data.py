...
def calculate_demographic_data(print_data=True):
    ...
    country_earning_stats = df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts()
    highest_earning_country = country_earning_stats.idxmax()
    highest_earning_country_percentage = round(country_earning_stats.max() * 100, 1)
